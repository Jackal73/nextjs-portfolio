...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <a className="px-2 py-1 my-2 bg-gray-200 dark:bg-dark-300 dark:bg-black-500 rounded-full flex items-center
            ...
            {/* address */}
            <div className="py-4 my-5 bg-gray-300 rounded dark:bg-dark-200 dark:bg-black-500"
            ...
            <button
                onClick={changeTheme}
                className="bg-gradient-to-r from-green to-blue-500 w-8/12 rounded-full py-2 px-5 text-white mb-1
